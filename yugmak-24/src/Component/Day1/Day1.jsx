...
const Day1 = () => {
  return (
    <div>
      ...
      <div className="section_home_project_6 opacity-100">
        <div className="rotation_hide_container">
          <div className="project_6_rotate">
            <div className="project_6_rotate_background"></div>
      ...
      <div className="section_home_project_7 opacity-95">
        <div className="rotation_hide_container">
          <div className="project_7_rotate">
            <div className="project_7_rotate_background"></div>
            <div className="gradient_cover"></div>
          </div>
        </div>
        <div className="container_project_2-home clearfix">
          <div className="project_8_div">
            ...
            <a
              ...
              className="text-link home opacity-65 transform translate-y-[43.8768px]"
            >
      ...
      <div className="section_home_project_8 opacity-100">
        <div className="rotation_hide_container">
          <div className="project_8_rotate">
            <div className="project_8_rotate_background"></div>
